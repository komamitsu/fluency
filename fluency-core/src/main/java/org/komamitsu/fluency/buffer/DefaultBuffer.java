...
public class DefaultBuffer
        implements Buffer
{
    private static final Logger LOG = LoggerFactory.getLogger(DefaultBuffer.class);
    ...
    public DefaultBuffer(RecordFormatter recordFormatter)
    {
        this(new Config(), recordFormatter);
    }

    public DefaultBuffer(final Config config, RecordFormatter recordFormatter)
    {
            ...
            throws BufferFullException
    {
        ...
        if (acquiredBuffer == null) {
            throw new BufferFullException("DefaultBuffer is full. config=" + config + ", bufferPool=" + bufferPool);
        }
    ...
    // TODO: Can't DefaultBuffer hold `intester` as an instance variable?
        ...
        void validateValues()
        {
            ...
            if (chunkInitialSize >= chunkRetentionSize) {
                throw new IllegalArgumentException(
                        String.format(
                                "DefaultBuffer Chunk Retention Size (%d) should be more than Initial DefaultBuffer Chunk Size (%d)",
            ...
            if (chunkRetentionSize >= maxBufferSize) {
                throw new IllegalArgumentException(
                        String.format(
                                "Max Total DefaultBuffer Size (%d) should be more than DefaultBuffer Chunk Retention Size (%d)",

...
class RetryableSenderTest {
  ...
  @Test
  void testSendRetryOver() throws IOException {
    ExponentialBackOffRetryStrategy.Config retryStrategyConfig =
        new ExponentialBackOffRetryStrategy.Config();
    ...
    assertThat(baseSender.getRetry()).isEqualTo(0);
    assertThrows(
        RetryableSender.RetryOverException.class, () -> sender.send(ByteBuffer.allocate(64)));
  }

  static class FailurableSender extends FluentdSender {

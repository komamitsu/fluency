...
public class HeartbeaterTest {
  ...
  private static class TestableHeartbeater extends InetSocketHeartbeater {
    ...
    protected void invoke() {
      pongedRecords.add(
          new Tuple3<>(System.currentTimeMillis(), config.getHost(), config.getPort()));
    }

    private static class Config extends InetSocketHeartbeater.Config {}
  }
}

...
public abstract class Heartbeater implements Closeable {
  ...
  public void start() {
    executorService.scheduleAtFixedRate(
        this::ping, config.getIntervalMillis(), config.getIntervalMillis(), TimeUnit.MILLISECONDS);
  }
  ...
  public String toString() {
    return "Heartbeater{" + "config=" + config + '}';
  }
  ...
  public static class Config implements Validatable {
    ...
    @Override
    public String toString() {
      return "Config{" + "intervalMillis=" + intervalMillis + '}';
    }
  }
}
